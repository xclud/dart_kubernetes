...
class ReplicaSetList {
  ...
  factory ReplicaSetList.fromJson(Map<String, dynamic> json) {
    ...
    final List<ReplicaSet> tempItems = List<dynamic>.from(tempItemsJson)
        .map((e) => ReplicaSet.fromJson(Map<String, dynamic>.from(e)))
        .toList();
