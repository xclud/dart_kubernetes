...
class StorageClassList {
  ...
  factory StorageClassList.fromJson(Map<String, dynamic> json) {
    ...
    final List<StorageClass> tempItems = List<dynamic>.from(tempItemsJson)
        .map((e) => StorageClass.fromJson(Map<String, dynamic>.from(e)))
        .toList();
