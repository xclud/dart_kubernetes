...
class SelfSubjectAccessReview {
  ...
  factory SelfSubjectAccessReview.fromJson(Map<String, dynamic> json) {
    ...
    final SelfSubjectAccessReviewSpec tempSpec =
        SelfSubjectAccessReviewSpec.fromJson(tempSpecJson);
