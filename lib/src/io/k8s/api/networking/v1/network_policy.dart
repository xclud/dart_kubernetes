...
class NetworkPolicy {
  ...
  factory NetworkPolicy.fromJson(Map<String, dynamic> json) {
    ...
    final NetworkPolicySpec? tempSpec =
        tempSpecJson != null ? NetworkPolicySpec.fromJson(tempSpecJson) : null;
    final NetworkPolicyStatus? tempStatus = tempStatusJson != null
        ? NetworkPolicyStatus.fromJson(tempStatusJson)
        : null;
