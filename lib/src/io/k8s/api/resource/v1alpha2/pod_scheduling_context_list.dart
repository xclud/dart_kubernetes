...
class PodSchedulingContextList {
  /// Default constructor.
  const PodSchedulingContextList({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  /// Creates a [PodSchedulingContextList] from JSON data.
  factory PodSchedulingContextList.fromJson(Map<String, dynamic> json) {
    ...
    final List<PodSchedulingContext> tempItems =
        List<dynamic>.from(tempItemsJson)
            .map(
              (e) => PodSchedulingContext.fromJson(
  ...
  /// Converts a [PodSchedulingContextList] instance to JSON data.
