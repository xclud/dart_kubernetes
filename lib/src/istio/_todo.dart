class AuthorizationPolicySpec {
  ...
  const AuthorizationPolicySpec();

  /// Creates a AuthorizationPolicySpec from JSON data.
  AuthorizationPolicySpec.fromJson(Map<String, dynamic> json) : this();
}
...
class AuthorizationPolicyStatus {
  ...
  /// Creates a AuthorizationPolicyStatus from JSON data.
...
class DestinationRuleStatus {
  ...
  /// Creates a DestinationRuleStatus from JSON data.
...
class EnvoyFilterSpec {
  ...
  /// Creates a EnvoyFilterSpec from JSON data.
...
class EnvoyFilterStatus {
  ...
  /// Creates a EnvoyFilterStatus from JSON data.
...
class ServiceEntryStatus {
  ...
  /// Creates a ServiceEntryStatus from JSON data.
...
class SidecarSpec {
  ...
  /// Creates a SidecarSpec from JSON data.
...
class SidecarStatus {
  ...
  /// Creates a SidecarStatus from JSON data.
...
class TelemetryStatus {
  ...
  /// Creates a TelemetryStatus from JSON data.
...
class VirtualServiceStatus {
  ...
  /// Creates a VirtualServiceStatus from JSON data.
...
class WorkloadEntrySpec {
  ...
  /// Creates a WorkloadEntrySpec from JSON data.
...
class WorkloadEntryStatus {
  ...
  /// Creates a WorkloadEntryStatus from JSON data.
...
class WorkloadGroupSpec {
  ...
  /// Creates a WorkloadGroupSpec from JSON data.
...
class WorkloadGroupStatus {
  ...
  /// Creates a WorkloadGroupStatus from JSON data.
  WorkloadGroupStatus.fromJson(Map<String, dynamic> json) : this();
}
