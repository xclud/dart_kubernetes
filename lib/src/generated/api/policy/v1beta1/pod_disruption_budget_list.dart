import 'package:kubernetes/src/generated/api/policy/v1beta1/pod_disruption_budget.dart';
...
class PodDisruptionBudgetList {
  ...
  PodDisruptionBudgetList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null
              ? PodDisruptionBudget.listFromJson(
  ...
  static List<PodDisruptionBudgetList> listFromJson(
