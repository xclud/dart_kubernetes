import 'package:kubernetes/src/generated/api/admissionregistration/v1/validating_webhook_configuration.dart';
...
class ValidatingWebhookConfigurationList {
  ...
  ValidatingWebhookConfigurationList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null
              ? ValidatingWebhookConfiguration.listFromJson(
  ...
  static List<ValidatingWebhookConfigurationList> listFromJson(
      Iterable<Map<String, dynamic>> list) {
    return list
        .map((e) => ValidatingWebhookConfigurationList.fromJson(e))
        .toList();
  }
