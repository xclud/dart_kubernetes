import 'package:kubernetes/src/generated/api/certificates/v1/certificate_signing_request_condition.dart';
  ...
  CertificateSigningRequestStatus.fromJson(Map<String, dynamic> json)
      : this(
          ...
          conditions: json['conditions'] != null
              ? CertificateSigningRequestCondition.listFromJson(
                  (json['conditions'] as Iterable).cast<Map<String, dynamic>>())
              : null,
        );

  /// Creates a list of CertificateSigningRequestStatus from JSON data.
  static List<CertificateSigningRequestStatus> listFromJson(
      Iterable<Map<String, dynamic>> list) {
    return list
        .map((e) => CertificateSigningRequestStatus.fromJson(e))
        .toList();
  }
