...
class CustomResourceDefinitionCondition {
  ...
  static List<CustomResourceDefinitionCondition> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => CustomResourceDefinitionCondition.fromJson(e)).toList();
  }
