import 'package:kubernetes/src/generated/kubernetes/apiextensions-apiserver/pkg/apis/apiextensions/v1/webhook_conversion.dart';
...
class CustomResourceConversion {
  ...
  CustomResourceConversion.fromJson(Map<String, dynamic> json)
      : this(
          ...
          webhook: json['webhook'] != null ? WebhookConversion.fromJson(json['webhook']): null,
        );

  /// Creates a list of CustomResourceConversion from JSON data.
  static List<CustomResourceConversion> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(webhook != null) { jsonData['webhook'] = webhook!.toJson(); }
