...
class CustomResourceDefinitionList {
  ...
  CustomResourceDefinitionList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? CustomResourceDefinition.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<CustomResourceDefinitionList> listFromJson(Iterable<Map<String, dynamic>> list) {
