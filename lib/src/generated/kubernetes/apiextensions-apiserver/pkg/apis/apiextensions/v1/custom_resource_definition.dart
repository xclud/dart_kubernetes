...
import 'package:kubernetes/src/generated/kubernetes/apiextensions-apiserver/pkg/apis/apiextensions/v1/custom_resource_definition_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/apiextensions-apiserver/pkg/apis/apiextensions/v1/custom_resource_definition_status.dart';
...
class CustomResourceDefinition {
  ...
  CustomResourceDefinition.fromJson(Map<String, dynamic> json)
      : this(
          ...
          status: json['status'] != null ? CustomResourceDefinitionStatus.fromJson(json['status']): null,
        );

  /// Creates a list of CustomResourceDefinition from JSON data.
  static List<CustomResourceDefinition> listFromJson(Iterable<Map<String, dynamic>> list) {
