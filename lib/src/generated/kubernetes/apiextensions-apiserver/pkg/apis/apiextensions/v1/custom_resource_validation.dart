...
class CustomResourceValidation {
  ...
  CustomResourceValidation.fromJson(Map<String, dynamic> json)
      : this(
          openAPIV3Schema: json['openAPIV3Schema'] != null ? JSONSchemaProps.fromJson(json['openAPIV3Schema']): null,
        );

  /// Creates a list of CustomResourceValidation from JSON data.
  static List<CustomResourceValidation> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(openAPIV3Schema != null) { jsonData['openAPIV3Schema'] = openAPIV3Schema!.toJson(); }
