...
class CustomResourceSubresourceStatus {
  ...
  CustomResourceSubresourceStatus.fromJson(Map<String, dynamic> json)
      : this(
          
        );

  /// Creates a list of CustomResourceSubresourceStatus from JSON data.
  static List<CustomResourceSubresourceStatus> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => CustomResourceSubresourceStatus.fromJson(e)).toList();
  }
