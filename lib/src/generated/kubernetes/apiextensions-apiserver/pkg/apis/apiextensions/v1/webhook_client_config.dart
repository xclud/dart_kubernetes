import 'package:kubernetes/src/generated/kubernetes/apiextensions-apiserver/pkg/apis/apiextensions/v1/service_reference.dart';
...
class WebhookClientConfig {
  ...
  static List<WebhookClientConfig> listFromJson(Iterable<Map<String, dynamic>> list) {
