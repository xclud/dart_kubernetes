import 'package:kubernetes/src/generated/kubernetes/api/coordination/v1/lease.dart';
...
class LeaseList {
  ...
  LeaseList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? Lease.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
