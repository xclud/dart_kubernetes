import 'package:kubernetes/src/generated/kubernetes/api/rbac/v1/role.dart';
...
class RoleList {
  ...
  RoleList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? Role.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  /// Converts a RoleList instance to JSON data.
