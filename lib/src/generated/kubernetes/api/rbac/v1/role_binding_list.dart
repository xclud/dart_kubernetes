import 'package:kubernetes/src/generated/kubernetes/api/rbac/v1/role_binding.dart';
...
class RoleBindingList {
  ...
  RoleBindingList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? RoleBinding.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of RoleBindingList from JSON data.
  static List<RoleBindingList> listFromJson(Iterable<Map<String, dynamic>> list) {
