import 'package:kubernetes/src/generated/kubernetes/api/rbac/v1/cluster_role.dart';
...
class ClusterRoleList {
  ...
  ClusterRoleList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ClusterRole.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ClusterRoleList from JSON data.
  static List<ClusterRoleList> listFromJson(Iterable<Map<String, dynamic>> list) {
