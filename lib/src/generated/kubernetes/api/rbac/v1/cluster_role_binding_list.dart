import 'package:kubernetes/src/generated/kubernetes/api/rbac/v1/cluster_role_binding.dart';
...
class ClusterRoleBindingList {
  ...
  ClusterRoleBindingList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ClusterRoleBinding.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ClusterRoleBindingList from JSON data.
  static List<ClusterRoleBindingList> listFromJson(Iterable<Map<String, dynamic>> list) {
