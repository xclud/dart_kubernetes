...
import 'package:kubernetes/src/generated/kubernetes/api/authentication/v1/token_request_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/authentication/v1/token_request_status.dart';
...
class TokenRequest {
  ...
  TokenRequest.fromJson(Map<String, dynamic> json)
      : this(
          ...
          status: json['status'] != null ? TokenRequestStatus.fromJson(json['status']): null,
        );
