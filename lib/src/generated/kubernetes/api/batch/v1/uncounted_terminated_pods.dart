...
class UncountedTerminatedPods {
  ...
  UncountedTerminatedPods.fromJson(Map<String, dynamic> json)
      : this(
          failed: json['failed'] != null ? List<String>.from(json['failed']) : null,
          succeeded: json['succeeded'] != null ? List<String>.from(json['succeeded']) : null,
        );

  /// Creates a list of UncountedTerminatedPods from JSON data.
  static List<UncountedTerminatedPods> listFromJson(Iterable<Map<String, dynamic>> list) {
