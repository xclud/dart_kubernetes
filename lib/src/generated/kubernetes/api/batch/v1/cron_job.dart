...
import 'package:kubernetes/src/generated/kubernetes/api/batch/v1/cron_job_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/batch/v1/cron_job_status.dart';
...
class CronJob {
  ...
  CronJob.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? CronJobSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? CronJobStatus.fromJson(json['status']): null,
        );
