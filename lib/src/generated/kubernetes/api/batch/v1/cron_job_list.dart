import 'package:kubernetes/src/generated/kubernetes/api/batch/v1/cron_job.dart';
...
class CronJobList {
  ...
  CronJobList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? CronJob.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
