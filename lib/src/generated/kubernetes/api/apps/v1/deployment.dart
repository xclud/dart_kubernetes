...
import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/deployment_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/deployment_status.dart';
...
class Deployment {
  ...
  Deployment.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? DeploymentSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? DeploymentStatus.fromJson(json['status']): null,
        );
  ...
  /// Converts a Deployment instance to JSON data.
