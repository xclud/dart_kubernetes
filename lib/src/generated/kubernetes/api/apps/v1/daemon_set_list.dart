import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/daemon_set.dart';
...
class DaemonSetList {
  ...
  DaemonSetList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? DaemonSet.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
