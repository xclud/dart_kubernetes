...
class ReplicaSetList {
  ...
  ReplicaSetList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ReplicaSet.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ReplicaSetList from JSON data.
  static List<ReplicaSetList> listFromJson(Iterable<Map<String, dynamic>> list) {
