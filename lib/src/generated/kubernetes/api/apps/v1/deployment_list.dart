import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/deployment.dart';
...
class DeploymentList {
  ...
  DeploymentList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? Deployment.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of DeploymentList from JSON data.
  static List<DeploymentList> listFromJson(Iterable<Map<String, dynamic>> list) {
