import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/stateful_set.dart';
...
class StatefulSetList {
  ...
  StatefulSetList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? StatefulSet.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of StatefulSetList from JSON data.
  static List<StatefulSetList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => StatefulSetList.fromJson(e)).toList();
  }

  /// Converts a StatefulSetList instance to JSON data.
