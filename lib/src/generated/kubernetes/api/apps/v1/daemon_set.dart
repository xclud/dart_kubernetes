...
import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/daemon_set_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/daemon_set_status.dart';
...
class DaemonSet {
  ...
  DaemonSet.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? DaemonSetSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? DaemonSetStatus.fromJson(json['status']): null,
        );
