import 'package:kubernetes/src/generated/kubernetes/api/apps/v1/controller_revision.dart';
...
class ControllerRevisionList {
  ...
  ControllerRevisionList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ControllerRevision.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ControllerRevisionList from JSON data.
  static List<ControllerRevisionList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => ControllerRevisionList.fromJson(e)).toList();
  }

  /// Converts a ControllerRevisionList instance to JSON data.
