...
class ResourceClaimStatus {
  ...
  ResourceClaimStatus.fromJson(Map<String, dynamic> json)
      : this(
          ...
          reservedFor: json['reservedFor'] != null
              ? ResourceClaimConsumerReference.listFromJson(
                  (json['reservedFor'] as Iterable)
                      .cast<Map<String, dynamic>>())
              : null,
        );

  /// Creates a list of ResourceClaimStatus from JSON data.
  static List<ResourceClaimStatus> listFromJson(
  ...
  Map<String, Object> toJson() {
    ...
    if (allocation != null) {
      jsonData['allocation'] = allocation!.toJson();
    }
    if (deallocationRequested != null) {
      jsonData['deallocationRequested'] = deallocationRequested!;
    }
    if (driverName != null) {
    ...
    if (reservedFor != null) {
      jsonData['reservedFor'] =
          reservedFor!.map((item) => item.toJson()).toList();
    }
