...
class ResourceClaimSchedulingStatus {
  ...
  ResourceClaimSchedulingStatus.fromJson(Map<String, dynamic> json)
      : this(
          name: json['name'],
          unsuitableNodes: json['unsuitableNodes'] != null
              ? List<String>.from(json['unsuitableNodes'])
              : null,
        );

  /// Creates a list of ResourceClaimSchedulingStatus from JSON data.
  static List<ResourceClaimSchedulingStatus> listFromJson(
  ...
  Map<String, Object> toJson() {
    ...
    if (unsuitableNodes != null) {
      jsonData['unsuitableNodes'] = unsuitableNodes!;
    }
