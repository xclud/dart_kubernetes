...
class ResourceClassList {
  ...
  ResourceClassList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ResourceClass.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ResourceClassList from JSON data.
  static List<ResourceClassList> listFromJson(Iterable<Map<String, dynamic>> list) {
