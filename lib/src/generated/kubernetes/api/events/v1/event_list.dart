import 'package:kubernetes/src/generated/kubernetes/api/events/v1/event.dart';
...
class EventList {
  ...
  EventList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? Event.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
