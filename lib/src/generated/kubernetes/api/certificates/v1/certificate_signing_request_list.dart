import 'package:kubernetes/src/generated/kubernetes/api/certificates/v1/certificate_signing_request.dart';
...
class CertificateSigningRequestList {
  ...
  CertificateSigningRequestList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? CertificateSigningRequest.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<CertificateSigningRequestList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => CertificateSigningRequestList.fromJson(e)).toList();
  }

  /// Converts a CertificateSigningRequestList instance to JSON data.
