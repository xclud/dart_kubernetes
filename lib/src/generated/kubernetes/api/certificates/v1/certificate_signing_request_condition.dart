...
class CertificateSigningRequestCondition {
  ...
  static List<CertificateSigningRequestCondition> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => CertificateSigningRequestCondition.fromJson(e)).toList();
  }
