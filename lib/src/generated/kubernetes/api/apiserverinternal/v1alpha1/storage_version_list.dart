...
class StorageVersionList {
  ...
  StorageVersionList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? StorageVersion.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of StorageVersionList from JSON data.
  static List<StorageVersionList> listFromJson(Iterable<Map<String, dynamic>> list) {
