...
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/node_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/node_status.dart';
...
class Node {
  ...
  Node.fromJson(Map<String, dynamic> json)
      : this(
          ...
          status: json['status'] != null ? NodeStatus.fromJson(json['status']): null,
        );
