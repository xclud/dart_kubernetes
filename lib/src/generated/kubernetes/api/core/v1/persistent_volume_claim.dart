...
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/persistent_volume_claim_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/persistent_volume_claim_status.dart';
...
class PersistentVolumeClaim {
  ...
  PersistentVolumeClaim.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? PersistentVolumeClaimSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? PersistentVolumeClaimStatus.fromJson(json['status']): null,
        );

  /// Creates a list of PersistentVolumeClaim from JSON data.
  static List<PersistentVolumeClaim> listFromJson(Iterable<Map<String, dynamic>> list) {
