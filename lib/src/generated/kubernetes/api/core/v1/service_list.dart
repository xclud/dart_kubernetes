import 'package:kubernetes/src/generated/kubernetes/api/core/v1/service.dart';
...
class ServiceList {
  ...
  ServiceList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? Service.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ServiceList from JSON data.
  static List<ServiceList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => ServiceList.fromJson(e)).toList();
  }
