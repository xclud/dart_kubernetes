...
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/replication_controller_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/replication_controller_status.dart';
...
class ReplicationController {
  ...
  ReplicationController.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? ReplicationControllerSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? ReplicationControllerStatus.fromJson(json['status']): null,
        );

  /// Creates a list of ReplicationController from JSON data.
  static List<ReplicationController> listFromJson(Iterable<Map<String, dynamic>> list) {
