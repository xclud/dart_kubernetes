import 'package:kubernetes/src/generated/kubernetes/api/core/v1/pod_template.dart';
...
class PodTemplateList {
  ...
  PodTemplateList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? PodTemplate.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of PodTemplateList from JSON data.
  static List<PodTemplateList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => PodTemplateList.fromJson(e)).toList();
  }

  /// Converts a PodTemplateList instance to JSON data.
