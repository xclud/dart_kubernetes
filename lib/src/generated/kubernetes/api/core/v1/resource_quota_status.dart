...
class ResourceQuotaStatus {
  ...
  ResourceQuotaStatus.fromJson(Map<String, dynamic> json)
      : this(
          ...
          used: json['used'] != null ? Map<String, String>.from(json['used']) : null,
        );

  /// Creates a list of ResourceQuotaStatus from JSON data.
  static List<ResourceQuotaStatus> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(used != null) { jsonData['used'] = used!; }
