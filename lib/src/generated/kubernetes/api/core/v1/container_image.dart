...
class ContainerImage {
  ...
  static List<ContainerImage> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(names != null) { jsonData['names'] = names!; }
    if(sizeBytes != null) { jsonData['sizeBytes'] = sizeBytes!; }
