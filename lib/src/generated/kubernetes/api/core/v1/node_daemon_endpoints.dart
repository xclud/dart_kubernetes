import 'package:kubernetes/src/generated/kubernetes/api/core/v1/daemon_endpoint.dart';
...
class NodeDaemonEndpoints {
  ...
  NodeDaemonEndpoints.fromJson(Map<String, dynamic> json)
      : this(
          kubeletEndpoint: json['kubeletEndpoint'] != null ? DaemonEndpoint.fromJson(json['kubeletEndpoint']): null,
        );

  /// Creates a list of NodeDaemonEndpoints from JSON data.
  static List<NodeDaemonEndpoints> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(kubeletEndpoint != null) { jsonData['kubeletEndpoint'] = kubeletEndpoint!.toJson(); }
