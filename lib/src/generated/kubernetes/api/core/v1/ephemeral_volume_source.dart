...
class EphemeralVolumeSource {
  ...
  EphemeralVolumeSource.fromJson(Map<String, dynamic> json)
      : this(
          volumeClaimTemplate: json['volumeClaimTemplate'] != null ? PersistentVolumeClaimTemplate.fromJson(json['volumeClaimTemplate']): null,
        );

  /// Creates a list of EphemeralVolumeSource from JSON data.
  static List<EphemeralVolumeSource> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(volumeClaimTemplate != null) { jsonData['volumeClaimTemplate'] = volumeClaimTemplate!.toJson(); }
