...
class PhotonPersistentDiskVolumeSource {
  ...
  static List<PhotonPersistentDiskVolumeSource> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => PhotonPersistentDiskVolumeSource.fromJson(e)).toList();
  }
