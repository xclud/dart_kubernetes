...
class EphemeralContainer {
  ...
  static List<EphemeralContainer> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(targetContainerName != null) { jsonData['targetContainerName'] = targetContainerName!; }
