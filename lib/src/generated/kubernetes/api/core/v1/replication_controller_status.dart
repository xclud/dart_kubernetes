import 'package:kubernetes/src/generated/kubernetes/api/core/v1/replication_controller_condition.dart';
...
class ReplicationControllerStatus {
  ...
  ReplicationControllerStatus.fromJson(Map<String, dynamic> json)
      : this(
          ...
          conditions: json['conditions'] != null ? ReplicationControllerCondition.listFromJson((json['conditions'] as Iterable).cast<Map<String, dynamic>>()): null,
  ...
  static List<ReplicationControllerStatus> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(fullyLabeledReplicas != null) { jsonData['fullyLabeledReplicas'] = fullyLabeledReplicas!; }
