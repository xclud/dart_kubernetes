import 'package:kubernetes/src/generated/kubernetes/api/core/v1/endpoints.dart';
...
class EndpointsList {
  ...
  EndpointsList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? Endpoints.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
