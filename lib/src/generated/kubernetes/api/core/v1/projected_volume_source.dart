import 'package:kubernetes/src/generated/kubernetes/api/core/v1/volume_projection.dart';
...
class ProjectedVolumeSource {
  ...
  ProjectedVolumeSource.fromJson(Map<String, dynamic> json)
      : this(
          ...
          sources: json['sources'] != null ? VolumeProjection.listFromJson((json['sources'] as Iterable).cast<Map<String, dynamic>>()): null,
        );

  /// Creates a list of ProjectedVolumeSource from JSON data.
  static List<ProjectedVolumeSource> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(sources != null) { jsonData['sources'] = sources!.map((item) => item.toJson()).toList(); }
