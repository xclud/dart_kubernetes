import 'package:kubernetes/src/generated/kubernetes/api/core/v1/replication_controller.dart';
...
class ReplicationControllerList {
  ...
  ReplicationControllerList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ReplicationController.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<ReplicationControllerList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => ReplicationControllerList.fromJson(e)).toList();
  }

  /// Converts a ReplicationControllerList instance to JSON data.
