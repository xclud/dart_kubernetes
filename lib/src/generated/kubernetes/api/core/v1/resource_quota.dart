...
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/resource_quota_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/resource_quota_status.dart';
...
class ResourceQuota {
  ...
  ResourceQuota.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? ResourceQuotaSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? ResourceQuotaStatus.fromJson(json['status']): null,
        );
