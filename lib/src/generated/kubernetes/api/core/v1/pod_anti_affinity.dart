...
class PodAntiAffinity {
  ...
  PodAntiAffinity.fromJson(Map<String, dynamic> json)
      : this(
          preferredDuringSchedulingIgnoredDuringExecution: json['preferredDuringSchedulingIgnoredDuringExecution'] != null ? WeightedPodAffinityTerm.listFromJson((json['preferredDuringSchedulingIgnoredDuringExecution'] as Iterable).cast<Map<String, dynamic>>()): null,
          requiredDuringSchedulingIgnoredDuringExecution: json['requiredDuringSchedulingIgnoredDuringExecution'] != null ? PodAffinityTerm.listFromJson((json['requiredDuringSchedulingIgnoredDuringExecution'] as Iterable).cast<Map<String, dynamic>>()): null,
        );

  /// Creates a list of PodAntiAffinity from JSON data.
  static List<PodAntiAffinity> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(requiredDuringSchedulingIgnoredDuringExecution != null) { jsonData['requiredDuringSchedulingIgnoredDuringExecution'] = requiredDuringSchedulingIgnoredDuringExecution!.map((item) => item.toJson()).toList(); }
