import 'package:kubernetes/src/generated/kubernetes/api/core/v1/resource_quota.dart';
...
class ResourceQuotaList {
  ...
  ResourceQuotaList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ResourceQuota.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ResourceQuotaList from JSON data.
  static List<ResourceQuotaList> listFromJson(Iterable<Map<String, dynamic>> list) {
