...
class LoadBalancerStatus {
  ...
  LoadBalancerStatus.fromJson(Map<String, dynamic> json)
      : this(
          ingress: json['ingress'] != null ? LoadBalancerIngress.listFromJson((json['ingress'] as Iterable).cast<Map<String, dynamic>>()): null,
        );

  /// Creates a list of LoadBalancerStatus from JSON data.
  static List<LoadBalancerStatus> listFromJson(Iterable<Map<String, dynamic>> list) {
