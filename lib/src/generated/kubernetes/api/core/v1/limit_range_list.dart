import 'package:kubernetes/src/generated/kubernetes/api/core/v1/limit_range.dart';
...
class LimitRangeList {
  ...
  LimitRangeList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? LimitRange.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of LimitRangeList from JSON data.
  static List<LimitRangeList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => LimitRangeList.fromJson(e)).toList();
  }

  /// Converts a LimitRangeList instance to JSON data.
