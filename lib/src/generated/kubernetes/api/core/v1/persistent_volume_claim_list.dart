...
class PersistentVolumeClaimList {
  ...
  PersistentVolumeClaimList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? PersistentVolumeClaim.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<PersistentVolumeClaimList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => PersistentVolumeClaimList.fromJson(e)).toList();
  }

  /// Converts a PersistentVolumeClaimList instance to JSON data.
