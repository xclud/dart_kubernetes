import 'package:kubernetes/src/generated/kubernetes/api/core/v1/service_port.dart';
import 'package:kubernetes/src/generated/kubernetes/api/core/v1/session_affinity_config.dart';
...
class ServiceSpec {
  ...
  /// Creates a list of ServiceSpec from JSON data.
  static List<ServiceSpec> listFromJson(Iterable<Map<String, dynamic>> list) {
