...
class ServiceAccountList {
  ...
  ServiceAccountList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ServiceAccount.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ServiceAccountList from JSON data.
  static List<ServiceAccountList> listFromJson(Iterable<Map<String, dynamic>> list) {
