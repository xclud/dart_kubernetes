...
class PersistentVolume {
  ...
  PersistentVolume.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? PersistentVolumeSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? PersistentVolumeStatus.fromJson(json['status']): null,
        );

  /// Creates a list of PersistentVolume from JSON data.
  static List<PersistentVolume> listFromJson(Iterable<Map<String, dynamic>> list) {
