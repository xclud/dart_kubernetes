import 'package:kubernetes/src/generated/kubernetes/api/core/v1/config_map.dart';
...
class ConfigMapList {
  ...
  ConfigMapList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ConfigMap.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
