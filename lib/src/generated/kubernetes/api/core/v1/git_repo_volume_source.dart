...
class GitRepoVolumeSource {
  ...
  static List<GitRepoVolumeSource> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(directory != null) { jsonData['directory'] = directory!; }
    jsonData['repository'] = repository;
    if(revision != null) { jsonData['revision'] = revision!; }
