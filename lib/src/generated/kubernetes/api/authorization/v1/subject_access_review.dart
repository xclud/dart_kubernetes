...
import 'package:kubernetes/src/generated/kubernetes/api/authorization/v1/subject_access_review_spec.dart';
...
class SubjectAccessReview {
  ...
  static List<SubjectAccessReview> listFromJson(Iterable<Map<String, dynamic>> list) {
