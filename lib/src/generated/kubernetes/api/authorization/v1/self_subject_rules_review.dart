...
import 'package:kubernetes/src/generated/kubernetes/api/authorization/v1/self_subject_rules_review_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/authorization/v1/subject_rules_review_status.dart';
...
class SelfSubjectRulesReview {
  ...
  SelfSubjectRulesReview.fromJson(Map<String, dynamic> json)
      : this(
          ...
          status: json['status'] != null ? SubjectRulesReviewStatus.fromJson(json['status']): null,
        );

  /// Creates a list of SelfSubjectRulesReview from JSON data.
  static List<SelfSubjectRulesReview> listFromJson(Iterable<Map<String, dynamic>> list) {
