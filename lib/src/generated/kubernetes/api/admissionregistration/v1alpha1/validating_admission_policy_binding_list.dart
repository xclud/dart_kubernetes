...
class ValidatingAdmissionPolicyBindingList {
  ...
  ValidatingAdmissionPolicyBindingList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null
              ? ValidatingAdmissionPolicyBinding.listFromJson(
  ...
  static List<ValidatingAdmissionPolicyBindingList> listFromJson(
      Iterable<Map<String, dynamic>> list) {
    return list
        .map((e) => ValidatingAdmissionPolicyBindingList.fromJson(e))
        .toList();
  }
