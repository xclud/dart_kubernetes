...
class Validation {
  ...
  /// Creates a Validation from JSON data.
  ...
  /// Creates a list of Validation from JSON data.
  static List<Validation> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => Validation.fromJson(e)).toList();
  }

  /// Converts a Validation instance to JSON data.
