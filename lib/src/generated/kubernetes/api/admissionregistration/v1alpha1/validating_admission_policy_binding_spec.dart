...
class ValidatingAdmissionPolicyBindingSpec {
  ...
  ValidatingAdmissionPolicyBindingSpec.fromJson(Map<String, dynamic> json)
      : this(
          matchResources: json['matchResources'] != null
              ? MatchResources.fromJson(json['matchResources'])
              : null,
          paramRef: json['paramRef'] != null
              ? ParamRef.fromJson(json['paramRef'])
              : null,
          policyName: json['policyName'],
        );

  /// Creates a list of ValidatingAdmissionPolicyBindingSpec from JSON data.
  static List<ValidatingAdmissionPolicyBindingSpec> listFromJson(
      Iterable<Map<String, dynamic>> list) {
    return list
        .map((e) => ValidatingAdmissionPolicyBindingSpec.fromJson(e))
        .toList();
  }
  ...
  Map<String, Object> toJson() {
    ...
    if (matchResources != null) {
      jsonData['matchResources'] = matchResources!.toJson();
    }
    if (paramRef != null) {
      jsonData['paramRef'] = paramRef!.toJson();
    }
    if (policyName != null) {
      jsonData['policyName'] = policyName!;
    }
