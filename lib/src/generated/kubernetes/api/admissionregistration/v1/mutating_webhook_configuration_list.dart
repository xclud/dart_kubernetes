...
class MutatingWebhookConfigurationList {
  ...
  MutatingWebhookConfigurationList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? MutatingWebhookConfiguration.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<MutatingWebhookConfigurationList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => MutatingWebhookConfigurationList.fromJson(e)).toList();
  }
