...
class MutatingWebhook {
  ...
  MutatingWebhook.fromJson(Map<String, dynamic> json)
      : this(
          admissionReviewVersions: json['admissionReviewVersions'] != null ? List<String>.from(json['admissionReviewVersions']) : [],
          ...
          rules: json['rules'] != null ? RuleWithOperations.listFromJson((json['rules'] as Iterable).cast<Map<String, dynamic>>()): null,
          sideEffects: json['sideEffects'],
          timeoutSeconds: json['timeoutSeconds'],
        );

  /// Creates a list of MutatingWebhook from JSON data.
  static List<MutatingWebhook> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(failurePolicy != null) { jsonData['failurePolicy'] = failurePolicy!; }
    ...
    if(reinvocationPolicy != null) { jsonData['reinvocationPolicy'] = reinvocationPolicy!; }
