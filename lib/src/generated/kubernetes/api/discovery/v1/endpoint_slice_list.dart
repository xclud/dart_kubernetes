import 'package:kubernetes/src/generated/kubernetes/api/discovery/v1/endpoint_slice.dart';
...
class EndpointSliceList {
  ...
  EndpointSliceList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? EndpointSlice.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of EndpointSliceList from JSON data.
  static List<EndpointSliceList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => EndpointSliceList.fromJson(e)).toList();
  }

  /// Converts a EndpointSliceList instance to JSON data.
