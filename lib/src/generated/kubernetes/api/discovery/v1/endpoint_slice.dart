import 'package:kubernetes/src/generated/kubernetes/api/discovery/v1/endpoint.dart';
import 'package:kubernetes/src/generated/kubernetes/apimachinery/pkg/apis/meta/v1/object_meta.dart';
import 'package:kubernetes/src/generated/kubernetes/api/discovery/v1/endpoint_port.dart';
...
class EndpointSlice {
  ...
  EndpointSlice.fromJson(Map<String, dynamic> json)
      : this(
          ...
          endpoints: json['endpoints'] != null ? Endpoint.listFromJson((json['endpoints'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
