import 'package:kubernetes/src/generated/kubernetes/api/scheduling/v1/priority_class.dart';
...
class PriorityClassList {
  ...
  PriorityClassList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? PriorityClass.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of PriorityClassList from JSON data.
  static List<PriorityClassList> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => PriorityClassList.fromJson(e)).toList();
  }

  /// Converts a PriorityClassList instance to JSON data.
