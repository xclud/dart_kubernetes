import 'package:kubernetes/src/generated/kubernetes/api/flowcontrol/v1beta2/priority_level_configuration.dart';
...
class PriorityLevelConfigurationList {
  ...
  PriorityLevelConfigurationList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? PriorityLevelConfiguration.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<PriorityLevelConfigurationList> listFromJson(Iterable<Map<String, dynamic>> list) {
