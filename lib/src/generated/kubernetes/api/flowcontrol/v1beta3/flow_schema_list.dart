import 'package:kubernetes/src/generated/kubernetes/api/flowcontrol/v1beta3/flow_schema.dart';
...
class FlowSchemaList {
  ...
  FlowSchemaList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? FlowSchema.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of FlowSchemaList from JSON data.
  static List<FlowSchemaList> listFromJson(Iterable<Map<String, dynamic>> list) {
