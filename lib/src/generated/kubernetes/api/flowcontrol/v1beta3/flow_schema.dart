...
import 'package:kubernetes/src/generated/kubernetes/api/flowcontrol/v1beta3/flow_schema_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/flowcontrol/v1beta3/flow_schema_status.dart';
...
class FlowSchema {
  ...
  FlowSchema.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? FlowSchemaSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? FlowSchemaStatus.fromJson(json['status']): null,
        );
