...
class NetworkPolicyIngressRule {
  ...
  NetworkPolicyIngressRule.fromJson(Map<String, dynamic> json)
      : this(
          from: json['from'] != null ? NetworkPolicyPeer.listFromJson((json['from'] as Iterable).cast<Map<String, dynamic>>()): null,
  ...
  static List<NetworkPolicyIngressRule> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(from != null) { jsonData['from'] = from!.map((item) => item.toJson()).toList(); }
