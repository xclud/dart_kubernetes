...
import 'package:kubernetes/src/generated/kubernetes/api/networking/v1/network_policy_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/networking/v1/network_policy_status.dart';
...
class NetworkPolicy {
  ...
  NetworkPolicy.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? NetworkPolicySpec.fromJson(json['spec']): null,
          status: json['status'] != null ? NetworkPolicyStatus.fromJson(json['status']): null,
        );
  ...
  /// Converts a NetworkPolicy instance to JSON data.
