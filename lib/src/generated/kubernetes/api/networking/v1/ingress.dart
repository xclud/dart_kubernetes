...
import 'package:kubernetes/src/generated/kubernetes/api/networking/v1/ingress_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/networking/v1/ingress_status.dart';
...
class Ingress {
  ...
  Ingress.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? IngressSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? IngressStatus.fromJson(json['status']): null,
        );
