import 'package:kubernetes/src/generated/kubernetes/api/networking/v1/network_policy.dart';
...
class NetworkPolicyList {
  ...
  NetworkPolicyList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? NetworkPolicy.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of NetworkPolicyList from JSON data.
  static List<NetworkPolicyList> listFromJson(Iterable<Map<String, dynamic>> list) {
