...
class ClusterCIDRList {
  ...
  ClusterCIDRList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? ClusterCIDR.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of ClusterCIDRList from JSON data.
  static List<ClusterCIDRList> listFromJson(Iterable<Map<String, dynamic>> list) {
