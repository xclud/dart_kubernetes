import 'package:kubernetes/src/generated/kubernetes/api/node/v1/runtime_class.dart';
...
class RuntimeClassList {
  ...
  RuntimeClassList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? RuntimeClass.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of RuntimeClassList from JSON data.
  static List<RuntimeClassList> listFromJson(Iterable<Map<String, dynamic>> list) {
