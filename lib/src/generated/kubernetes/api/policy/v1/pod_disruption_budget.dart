...
import 'package:kubernetes/src/generated/kubernetes/api/policy/v1/pod_disruption_budget_spec.dart';
import 'package:kubernetes/src/generated/kubernetes/api/policy/v1/pod_disruption_budget_status.dart';
...
class PodDisruptionBudget {
  ...
  PodDisruptionBudget.fromJson(Map<String, dynamic> json)
      : this(
          ...
          spec: json['spec'] != null ? PodDisruptionBudgetSpec.fromJson(json['spec']): null,
          status: json['status'] != null ? PodDisruptionBudgetStatus.fromJson(json['status']): null,
        );

  /// Creates a list of PodDisruptionBudget from JSON data.
  static List<PodDisruptionBudget> listFromJson(Iterable<Map<String, dynamic>> list) {
