import 'package:kubernetes/src/generated/kubernetes/apimachinery/pkg/apis/meta/v1/delete_options.dart';
...
class Eviction {
  ...
  Eviction.fromJson(Map<String, dynamic> json)
      : this(
          ...
          deleteOptions: json['deleteOptions'] != null ? DeleteOptions.fromJson(json['deleteOptions']): null,
          kind: json['kind'],
  ...
  Map<String, Object> toJson()
  {
    ...
    if(deleteOptions != null) { jsonData['deleteOptions'] = deleteOptions!.toJson(); }
