import 'package:kubernetes/src/generated/kubernetes/api/autoscaling/v2/horizontal_pod_autoscaler.dart';
...
class HorizontalPodAutoscalerList {
  ...
  HorizontalPodAutoscalerList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? HorizontalPodAutoscaler.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  static List<HorizontalPodAutoscalerList> listFromJson(Iterable<Map<String, dynamic>> list) {
