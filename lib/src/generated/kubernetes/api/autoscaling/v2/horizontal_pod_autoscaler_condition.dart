...
class HorizontalPodAutoscalerCondition {
  ...
  static List<HorizontalPodAutoscalerCondition> listFromJson(Iterable<Map<String, dynamic>> list) {
    return list.map((e) => HorizontalPodAutoscalerCondition.fromJson(e)).toList();
  }
