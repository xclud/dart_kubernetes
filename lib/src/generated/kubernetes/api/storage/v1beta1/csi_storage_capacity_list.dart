import 'package:kubernetes/src/generated/kubernetes/api/storage/v1beta1/csi_storage_capacity.dart';
...
class CSIStorageCapacityList {
  ...
  CSIStorageCapacityList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? CSIStorageCapacity.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of CSIStorageCapacityList from JSON data.
  static List<CSIStorageCapacityList> listFromJson(Iterable<Map<String, dynamic>> list) {
