...
class CSIStorageCapacity {
  ...
  CSIStorageCapacity.fromJson(Map<String, dynamic> json)
      : this(
          ...
          nodeTopology: json['nodeTopology'] != null ? LabelSelector.fromJson(json['nodeTopology']): null,
          storageClassName: json['storageClassName'],
        );

  /// Creates a list of CSIStorageCapacity from JSON data.
  static List<CSIStorageCapacity> listFromJson(Iterable<Map<String, dynamic>> list) {
  ...
  Map<String, Object> toJson()
  {
    ...
    if(maximumVolumeSize != null) { jsonData['maximumVolumeSize'] = maximumVolumeSize!; }
    if(metadata != null) { jsonData['metadata'] = metadata!.toJson(); }
    if(nodeTopology != null) { jsonData['nodeTopology'] = nodeTopology!.toJson(); }
