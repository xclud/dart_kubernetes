import 'package:kubernetes/src/generated/kubernetes/api/storage/v1/volume_node_resources.dart';
...
class CSINodeDriver {
  ...
  static List<CSINodeDriver> listFromJson(Iterable<Map<String, dynamic>> list) {
