...
class CSIDriverSpec {
  ...
  CSIDriverSpec.fromJson(Map<String, dynamic> json)
      : this(
          ...
          tokenRequests: json['tokenRequests'] != null
              ? TokenRequest.listFromJson((json['tokenRequests'] as Iterable)
                  .cast<Map<String, dynamic>>())
              : null,
          volumeLifecycleModes: json['volumeLifecycleModes'] != null
  ...
  Map<String, Object> toJson() {
    ...
    if (seLinuxMount != null) {
      jsonData['seLinuxMount'] = seLinuxMount!;
    }
