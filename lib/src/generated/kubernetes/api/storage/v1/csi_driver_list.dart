import 'package:kubernetes/src/generated/kubernetes/api/storage/v1/csi_driver.dart';
...
class CSIDriverList {
  ...
  CSIDriverList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? CSIDriver.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
  ...
  /// Converts a CSIDriverList instance to JSON data.
