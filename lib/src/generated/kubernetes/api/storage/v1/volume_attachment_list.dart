...
class VolumeAttachmentList {
  ...
  VolumeAttachmentList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? VolumeAttachment.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
          metadata: json['metadata'] != null ? ListMeta.fromJson(json['metadata']): null,
        );

  /// Creates a list of VolumeAttachmentList from JSON data.
  static List<VolumeAttachmentList> listFromJson(Iterable<Map<String, dynamic>> list) {
