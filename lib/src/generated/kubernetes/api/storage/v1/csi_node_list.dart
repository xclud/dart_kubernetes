import 'package:kubernetes/src/generated/kubernetes/api/storage/v1/csi_node.dart';
...
class CSINodeList {
  ...
  CSINodeList.fromJson(Map<String, dynamic> json)
      : this(
          ...
          items: json['items'] != null ? CSINode.listFromJson((json['items'] as Iterable).cast<Map<String, dynamic>>()): [],
          kind: json['kind'],
